...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = (this.viewport.height * ((isMobile ? 1000 : 900) * this.scale)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * ((isMobile ? 820 : 700) * this.scale)) / this.screen.width;
    this.plane.program.uniforms.uPlaneSizes.value = [this.plane.scale.x, this.plane.scale.y];
    this.padding = isMobile ? 0.9 : 2;
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/images/gallery_customcake_2.jpg`, text: 'Ayesha Khan' },
      { image: `/images/gallery_dessert_3.jpg`, text: 'Bilal Ahmed' },
      { image: `/images/gallery_interior_2.jpg`, text: 'Sara Raza' },
      { image: `/images/gallery_customcake_3.jpg`, text: 'Hamza Tariq' },
      { image: `/images/gallery_event_2.jpg`, text: 'Mahnoor Ali' },
      { image: `/images/gallery_interior_3.jpg`, text: 'Zainab Shah' }
    ];
